...
When you need to obtain the thread group leader of a thread, `leader_tid` returns the process name of the leader thread of that thread group.
This is an alias for `task.real_parent.comm`.
...
When you need to obtain the thread group leader of a thread, `leader_tid` returns the process ID (PID) of the leader thread of that thread group.
This is an alias for `task.real_parent.pid`.

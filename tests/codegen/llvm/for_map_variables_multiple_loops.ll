...
entry:
  ...
  %for_each_map_elem = call i64 inttoptr (i64 617 to ptr)(ptr @AT_, ptr @map_for_each_cb, ptr %ctx, i64 0)
  ...
  %for_each_map_elem3 = call i64 inttoptr (i64 617 to ptr)(ptr @AT_, ptr @map_for_each_cb.1, ptr %ctx1, i64 0)
  ret i64 0
}

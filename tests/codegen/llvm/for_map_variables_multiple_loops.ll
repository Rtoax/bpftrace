...
%"struct map_internal_repr_t.182" = type { ptr, ptr }
%ctx_t.183 = type { ptr, ptr }
%ctx_t = type { ptr }
...
@ringbuf = dso_local global %"struct map_internal_repr_t.182" zeroinitializer, section ".maps", !dbg !26
...
entry:
  ...
  %"ctx.$var12" = getelementptr %ctx_t.183, ptr %2, i64 0, i32 0
  store ptr %"$var1", ptr %"ctx.$var12", align 8
  %3 = call ptr @llvm.preserve.static.offset(ptr %ctx1)
  %"ctx.$var2" = getelementptr %ctx_t.183, ptr %3, i64 0, i32 1
...
for_body:
  ...
  %5 = getelementptr %int64_int64__tuple_t, ptr %"$_", i32 0, i32 1
  store i64 %val, ptr %5, align 8
  %"ctx.$var1" = getelementptr %ctx_t.183, ptr %3, i64 0, i32 0
  %"$var1" = load ptr, ptr %"ctx.$var1", align 8
  %"ctx.$var2" = getelementptr %ctx_t.183, ptr %3, i64 0, i32 1

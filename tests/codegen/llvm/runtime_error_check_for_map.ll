...
@AT_x = dso_local global %"struct map_internal_repr_t.616" zeroinitializer, section ".maps", !dbg !26
@ringbuf = dso_local global %"struct map_internal_repr_t.617" zeroinitializer, section ".maps", !dbg !37
...
helper_merge:                                     ; preds = %counter_merge, %entry
  ...
  %for_each_map_elem = call i64 inttoptr (i64 617 to ptr)(ptr @AT_map, ptr @map_for_each_cb, ptr null, i64 0)

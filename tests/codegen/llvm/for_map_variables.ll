...
@ringbuf = dso_local global %"struct map_internal_repr_t.617" zeroinitializer, section ".maps", !dbg !31
...
entry:
  ...
  %for_each_map_elem = call i64 inttoptr (i64 617 to ptr)(ptr @AT_map, ptr @map_for_each_cb, ptr %ctx, i64 0)

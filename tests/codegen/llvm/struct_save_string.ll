...
@AT_str = dso_local global %"struct map_internal_repr_t.182" zeroinitializer, section ".maps", !dbg !26
@ringbuf = dso_local global %"struct map_internal_repr_t.183" zeroinitializer, section ".maps", !dbg !35

...
%"struct map_internal_repr_t.182" = type { ptr, ptr, ptr, ptr }
%"struct map_internal_repr_t.183" = type { ptr, ptr, ptr, ptr }
%"struct map_internal_repr_t.184" = type { ptr, ptr, ptr, ptr }
%"struct map_internal_repr_t.185" = type { ptr, ptr, ptr, ptr }
%"struct map_internal_repr_t.186" = type { ptr, ptr, ptr, ptr }
%"struct map_internal_repr_t.187" = type { ptr, ptr, ptr, ptr }
%"struct map_internal_repr_t.188" = type { ptr, ptr }
...
@AT_y = dso_local global %"struct map_internal_repr_t.182" zeroinitializer, section ".maps", !dbg !26
@AT_z = dso_local global %"struct map_internal_repr_t.183" zeroinitializer, section ".maps", !dbg !28
@stack_perf_127 = dso_local global %"struct map_internal_repr_t.184" zeroinitializer, section ".maps", !dbg !30
@stack_bpftrace_6 = dso_local global %"struct map_internal_repr_t.185" zeroinitializer, section ".maps", !dbg !54
@stack_bpftrace_127 = dso_local global %"struct map_internal_repr_t.186" zeroinitializer, section ".maps", !dbg !63
@stack_scratch = dso_local global %"struct map_internal_repr_t.187" zeroinitializer, section ".maps", !dbg !65
@ringbuf = dso_local global %"struct map_internal_repr_t.188" zeroinitializer, section ".maps", !dbg !75

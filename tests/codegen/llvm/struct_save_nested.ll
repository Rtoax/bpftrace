...
@AT_foo = dso_local global %"struct map_internal_repr_t.182" zeroinitializer, section ".maps", !dbg !26
@AT_x = dso_local global %"struct map_internal_repr_t.183" zeroinitializer, section ".maps", !dbg !35
@ringbuf = dso_local global %"struct map_internal_repr_t.184" zeroinitializer, section ".maps", !dbg !40

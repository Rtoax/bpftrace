...
@stack_scratch = dso_local global %"struct map_internal_repr_t.183" zeroinitializer, section ".maps", !dbg !50
@ringbuf = dso_local global %"struct map_internal_repr_t.184" zeroinitializer, section ".maps", !dbg !62

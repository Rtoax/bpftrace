...
@AT_c = dso_local global %"struct map_internal_repr_t.617" zeroinitializer, section ".maps", !dbg !24
@AT_d = dso_local global %"struct map_internal_repr_t.618" zeroinitializer, section ".maps", !dbg !26
@AT_e = dso_local global %"struct map_internal_repr_t.619" zeroinitializer, section ".maps", !dbg !28
@ringbuf = dso_local global %"struct map_internal_repr_t.620" zeroinitializer, section ".maps", !dbg !37

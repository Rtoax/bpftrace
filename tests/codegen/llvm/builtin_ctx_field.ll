...
%"struct map_internal_repr_t.186" = type { ptr, ptr }
...
@AT_b = dso_local global %"struct map_internal_repr_t.182" zeroinitializer, section ".maps", !dbg !22
@AT_c = dso_local global %"struct map_internal_repr_t.183" zeroinitializer, section ".maps", !dbg !24
@AT_d = dso_local global %"struct map_internal_repr_t.184" zeroinitializer, section ".maps", !dbg !26
@AT_e = dso_local global %"struct map_internal_repr_t.185" zeroinitializer, section ".maps", !dbg !28
@ringbuf = dso_local global %"struct map_internal_repr_t.186" zeroinitializer, section ".maps", !dbg !37

...
@stack_bpftrace_127 = dso_local global %"struct map_internal_repr_t.183" zeroinitializer, section ".maps", !dbg !35
@stack_scratch = dso_local global %"struct map_internal_repr_t.184" zeroinitializer, section ".maps", !dbg !55
@ringbuf = dso_local global %"struct map_internal_repr_t.185" zeroinitializer, section ".maps", !dbg !67

...
@stack_raw_127 = dso_local global %"struct map_internal_repr_t.182" zeroinitializer, section ".maps", !dbg !30
@stack_scratch = dso_local global %"struct map_internal_repr_t.183" zeroinitializer, section ".maps", !dbg !49
@ringbuf = dso_local global %"struct map_internal_repr_t.184" zeroinitializer, section ".maps", !dbg !66

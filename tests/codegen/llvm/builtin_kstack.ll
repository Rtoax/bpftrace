...
%"struct map_internal_repr_t.184" = type { ptr, ptr }
%kstack_key = type { i64, i64 }

@LICENSE = global [4 x i8] c"GPL\00", section "license", !dbg !0
@AT_x = dso_local global %"struct map_internal_repr_t" zeroinitializer, section ".maps", !dbg !7
@stack_bpftrace_127 = dso_local global %"struct map_internal_repr_t.182" zeroinitializer, section ".maps", !dbg !26
@stack_scratch = dso_local global %"struct map_internal_repr_t.183" zeroinitializer, section ".maps", !dbg !46
@ringbuf = dso_local global %"struct map_internal_repr_t.184" zeroinitializer, section ".maps", !dbg !58

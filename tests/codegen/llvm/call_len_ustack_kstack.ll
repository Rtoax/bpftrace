...
%"struct map_internal_repr_t.185" = type { ptr, ptr }
...
@AT_y = dso_local global %"struct map_internal_repr_t.182" zeroinitializer, section ".maps", !dbg !22
@stack_bpftrace_127 = dso_local global %"struct map_internal_repr_t.183" zeroinitializer, section ".maps", !dbg !24
@stack_scratch = dso_local global %"struct map_internal_repr_t.184" zeroinitializer, section ".maps", !dbg !48
@ringbuf = dso_local global %"struct map_internal_repr_t.185" zeroinitializer, section ".maps", !dbg !60

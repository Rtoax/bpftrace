...
@stack_bpftrace_6 = dso_local global %"struct map_internal_repr_t.185" zeroinitializer, section ".maps", !dbg !50
@stack_bpftrace_127 = dso_local global %"struct map_internal_repr_t.186" zeroinitializer, section ".maps", !dbg !59
@stack_scratch = dso_local global %"struct map_internal_repr_t.187" zeroinitializer, section ".maps", !dbg !61
@ringbuf = dso_local global %"struct map_internal_repr_t.188" zeroinitializer, section ".maps", !dbg !71

...
static size_t syscall_names_size = sizeof(syscall_names) / sizeof(syscall_names[0]);
#elif defined(__TARGET_ARCH_arm64) || defined(__TARGET_ARCH_riscv) || defined(__TARGET_ARCH_loongarch)
static m_str syscall_names[] = {
  [0] = "io_setup",
  [1] = "io_destroy",
  [2] = "io_submit",
